...
multiple_student_subjects = [
    (92400133189, 'om', 'PWP', 99),
    (92400133189, 'om', 'ICE', 99),
    (92400133189, 'om', 'DMGT', 99),
    (92400133189, 'om', 'DSC', 99),
    (92400133189, 'om', 'SS', 99),
    (92400133189, 'om', 'SPDT', 99),
    (92400133189, 'om', 'APTI', 99),
    (92400133189, 'om', 'COA', 99)
]
cursor.executemany('''
...
cursor.execute('''
    ...
    SET Mark = 98 
    WHERE Enrollment = 92400133189 AND Subject = 'ICE'
''')
conn.commit()
...
cursor.execute('''
    ...
    WHERE Enrollment = 92400133189 AND Subject = 'DMGT'
''')
conn.commit()
